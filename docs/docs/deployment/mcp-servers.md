...
A complete working example is in [`examples/python/openai_sdk_1.x/mcp/`](https://github.com/elbruno/azure-ai-proxy-lite/tree/main/examples/python/openai_sdk_1.x/mcp){:target="_blank"}:
