...
For the full local deployment reference (managing the stack, building custom images, multi-architecture builds), see the [Docker deployment guide](https://github.com/elbruno/azure-ai-proxy-lite/blob/main/docker/README.md){:target="_blank"}.
